// Поле прикрепления файла со скрепкой для модальных окон.
// Сохраняет переданный класс на <input>, чтобы существующие обработчики
// (modal.querySelector(".dish-image") и т.п.) продолжали работать.
    ...
    return `
        <div class="file-field-group">
            ...
            <label class="file-field">
                <span class="file-field-clip">📎</span>
